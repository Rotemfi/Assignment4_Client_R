...
private:
    ...
    //ggg
public:
    Read(ConnectionHandler &connectionHandler, bool &isLogout):connectionHandler(connectionHandler),isLogout(isLogout){}
...
//            while(isLogout) {
//                //cout<<"i'm going to busy wait until someone log in"<<endl;
//                //mtx.lock();
//            }
//            cout<<"I'm free to read again! someone release the key"<<endl;
        }
    }
...
private:
    ...
    bool &isLogout;
public:
    Write(ConnectionHandler &connectionHandler, bool &isLogout) : connectionHandler(connectionHandler),
                                                                  isLogout(isLogout) {}
...
int main (int argc, char *argv[]) {
    ...
    bool isLogOut=false;
    Read socketReader(connectionHandler,isLogOut);
    Write socketWrite(connectionHandler,isLogOut);
